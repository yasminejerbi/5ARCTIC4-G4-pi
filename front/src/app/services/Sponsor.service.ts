...
export class SponsorService {
  private ajouterurl ='http://192.168.33.10:9009/pi/sponsors/ajout';
  private listurl ='http://192.168.33.10:9009/pi/sponsors/getAll';
  private Url='http://192.168.33.10:9009/pi/sponsors/deleteID';
  private Urls='http://192.168.33.10:9009/pi/sponsors';
  private modifierurl = 'http://192.168.33.10:9009/pi/sponsors/update';
/*  
 ...
 /* ajouterSponsor(Sponsor: Sponsor) {
  ...
  modifierSponsor(Sponsor: Sponsor) {
   ...
   getSponsor(id: any) {
    return this.http.get('http://192.168.33.10:9009/pi/sponsors/getSponsorsId/' + id)
  }
  /*  supprimerSponsor(id: number): Observable<void> {
    return this.http.delete<void>(http://192.168.33.10:9009/pi/feedback/deleteID/${id});
   } */
