...
updateForum(forum:Forum){
  return this.http.put('http://localhost:9003/pi/Forums/updateForum',forum)
}
 getForumById(id:number){
    return this.http.get<Forum>('http://localhost:9003/pi/Forums/getForumId/'+id)
  }
