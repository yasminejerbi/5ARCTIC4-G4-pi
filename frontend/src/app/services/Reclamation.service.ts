...
export class ReclamationService {
  private ajouterurl = 'http://localhost:9003/pi/feedback/ajoutFeedback';
  private listurl = 'http://localhost:9003/pi/feedback/getAllFeedbacks';
  private Url = 'http://localhost:9003/pi/feedback/deleteID';
  private Urls = 'http://localhost:9003/pi/feedback';
  private modifierurl = 'http://localhost:9003/pi/feedback/updateFeedback';
  private chatboturl = 'http://localhost:9003/pi/askQuestion';
  /*  
  ...
  getReclamation(id: any) {
    return this.http.get('http://localhost:9003/pi/feedback/getFeedbackId/' + id)
  }
